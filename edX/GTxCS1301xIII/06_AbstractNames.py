...
def abstract_names( s ):

# Isolates sublists from tuple 
	# list1, list2, list3 = list_of_names
	
	lname_list = dict()

	for lists in s:
		fname_list = [i.split(" ")[0] for i in lists]
		lname_list[fname_list[0]] = sorted([i.split(" ")[1] for i in lists])
